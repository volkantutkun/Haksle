    ...
    */
    ...
    $.widget("ui.dropdownchecklist", {
        ...
        _appendDropContainer: function() {
			...
			var divApply = $('<div style="float:right;width:182px; cursor:pointer;"><div style="float:left;padding:3px 0 3px 3px"><div class="fleft clearfix"><a class="link-button-smallOrange sprite" onclick="__doPostBack(\'UpdateUserSelection\',\'\')"><span class="sprite">Çoklu Seçimi Uygula</span></a></div></div></div><div style="clear:both"></div>');
            divApply.css('background-color', '#fcf5db');
            divApply.css('border-left', '1px solid #999999').css('border-right', '1px solid #999999');
            wrapper.append(divApply);
